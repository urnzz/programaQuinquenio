...
class Ui_MainWindow(object):
    ...
    def callAutoSave(self, num):
           ...
           self.thread = Thread(target=self.ss, args=(nome,id1,cpf,sit,dataProx,respFech,data1,data2,data3,data4,data5,resp1,resp2,resp3,resp4,resp5,resm1,resm2,resm3,resm4,resm5,rg,iben,nben,cargo, sexo,dn,nmae,npai,end1,end2,end3,end4,end5,obs1,obs2,obs3,obs4,obs5,tel1,tel2, tel3, tel4,tel5, tel6, tel7, tel8, tel9, tel10, num))
           self.thread.start()

    def ss(self,nome,id1,cpf,sit,dataProx,respFech,data1,data2,data3,data4,data5,resp1,resp2,resp3,resp4,resp5,resm1,resm2,resm3,resm4,resm5,rg,iben,nben,cargo, sexo,dn,nmae,npai,end1,end2,end3,end4,end5,obs1,obs2,obs3,obs4,obs5,tel1,tel2, tel3, tel4,tel5, tel6, tel7, tel8, tel9, tel10, num):
           ...
           columnsList = ['nome', 'id', 'cpf', 'situacao', 'dataProx', 'respFech', 'data1', 'data2', 'data3', 'data4', 'data5', 'resp1', 'resp2', 'resp3', 'resp4', 'resp5', 'resm1', 'resm2', 'resm3', 'resm4', 'resm5', 'dataInic', 'numeroBeneficio', 'rg', 'nomeCargo', 'sexo', 'dn', 'nomeMae', 'nomePai', 'end1', 'end2', 'end3', 'end4', 'end5', 'obs1', 'obs2', 'obs3', 'obs4', 'obs5', 'tel1', 'tel2', 'tel3', 'tel4', 'tel5', 'tel6', 'tel7', 'tel8', 'tel9', 'tel10']
           argsList = [nome,id1,cpf,sit,dataProx,respFech,data1,data2,data3,data4,data5,resp1,resp2,resp3,resp4,resp5,resm1,resm2,resm3,resm4,resm5,iben,nben,rg,cargo,sexo,dn,nmae,npai,end1,end2,end3,end4,end5,obs1,obs2,obs3,obs4,obs5,tel1,tel2,tel3,tel4,tel5,tel6,tel7,tel8,tel9,tel10]
           lll=[]
           cont=0
           for i in columnsList:
               if str(str(self.result[self.n+num][i]).strip()) != str(str(argsList[cont]).strip()):
                   lll.append(i)
               cont+=1
           if len(lll) == 0 :
               connection = pymysql.connect(host='152.70.156.5', user='quinquenio', password='gabriel2671', database='quinquenio', charset='utf8mb4', cursorclass=pymysql.cursors.DictCursor)
